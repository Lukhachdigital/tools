...
const buildBasePrompt = (request: ScriptRequest, sceneCount: number, randomSeed: string) => {
    ...
    3. CHI TIẾT ĐẾN TỪNG MM (EXTREME DETAIL MAPPING) - QUAN TRỌNG NHẤT:
       ...
       A. VẬT DỤNG (OBJECTS):
          ...
          - PHẢI VIẾT: "cái bàn gỗ sồi tròn màu nâu sẫm có vết xước", "chiếc xe thể thao màu đỏ rực với vành xe mạ crôm sáng bóng", "cây kiếm thép dài rỉ sét with chuôi kiếm bọc da đen".
